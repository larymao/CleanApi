...
using CleanApi.Application.TodoItems.Commands.UpdateTodoItemDetail;
...
public class TodoItems : EndpointGroupBase
{
    ...
    public async Task<string> CreateTodoItem(ISender sender, CreateTodoItemCommand command)
    {
